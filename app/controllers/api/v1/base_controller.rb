class Api::V1::BaseController < ApplicationController
  ...
  def malformed_request
    render json: {error: "the request could not understood by the server due to malformed syntax\
    SHOULD NOT repeat the request without modifications.", status: 400},status: 400
  end
