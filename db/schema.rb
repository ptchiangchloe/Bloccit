...
ActiveRecord::Schema.define(version: 20160307223718) do
  ...
  create_table "commentable", force: :cascade do |t|
    t.integer  "comment_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  add_index "commentable", ["comment_id"], name: "index_commentable_on_comment_id"
  ...
  add_index "commentables", ["commentable_type", "commentable_id"], name: "index_commentables_on_commentable_type_and_commentable_id"
